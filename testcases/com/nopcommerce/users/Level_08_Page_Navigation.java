...
public class Level_08_Page_Navigation extends BaseTest {
	...
	public void User_02_Switch_Multiple_Page() {
		...
		downloadableProductPage = customerPage.openDownloadableProdcutPage();
		
		//Downloadable Products => Addresses
		addressesPage = downloadableProductPage.openAddressesPage();  // làm tiếp các step mình muốn
		
		// Addresses => Reward Points
		rewardPointPage = addressesPage.openRewardPointPage();  // làm tiếp các step mình muốn
		...
		downloadableProductPage = addressesPage.openDownloadableProdcutPage();
